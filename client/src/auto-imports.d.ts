...
declare global {
  ...
  const useDeleteStorePictureMutation: typeof import('./mutations/store/useDeleteStorePictureMutation')['default']
  ...
  const useStoreBooksQuery: typeof import('./queries/book/useStoreBooksQuery')['default']
  ...
  const useUploadStorePictureMutation: typeof import('./mutations/store/useUploadStorePictureMutation')['default']
...
declare global {
  // @ts-ignore
  export type { Component, ComponentPublicInstance, ComputedRef, DirectiveBinding, ExtractDefaultPropTypes, ExtractPropTypes, ExtractPublicPropTypes, InjectionKey, PropType, Ref, MaybeRefOrGetter, VNode, WritableComputedRef } from 'vue'
  import('vue')
  // @ts-ignore
  ...
  // @ts-ignore
  export type { UseFocusZoneOptions } from './composables/useFocusZone'
  import('./composables/useFocusZone')
  // @ts-ignore
  export type { UseMarkdownOptions } from './composables/useMarkdown'
  import('./composables/useMarkdown')
  // @ts-ignore
  export type { MetricMap } from './queries/server/useMetricsQuery'
  import('./queries/server/useMetricsQuery')
}
...
declare module 'vue' {
  interface ComponentCustomProperties {
    ...
    readonly useDeleteStorePictureMutation: UnwrapRef<typeof import('./mutations/store/useDeleteStorePictureMutation')['default']>
    ...
    readonly useStoreBooksQuery: UnwrapRef<typeof import('./queries/book/useStoreBooksQuery')['default']>
    ...
    readonly useUploadStorePictureMutation: UnwrapRef<typeof import('./mutations/store/useUploadStorePictureMutation')['default']>
