...
class CollectionControllerTest(
  ...
  private val admin = SpineStackUser("admin@example.org", "", true, "Admin", id = ADMIN_ID)
  private val owner = SpineStackUser("user@example.org", "", true, "User", id = OWNER_ID)
  private val user = SpineStackUser("user2@example.org", "", false, "User2", id = USER_ID)
