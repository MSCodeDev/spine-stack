...
import io.github.mscodedev.spinestack.domain.model.Book
import io.github.mscodedev.spinestack.domain.model.BookContributor
import io.github.mscodedev.spinestack.domain.model.BookLibraryChangedException
import io.github.mscodedev.spinestack.domain.model.BookLinks
...
import io.github.mscodedev.spinestack.domain.model.LibraryItem
...
import io.github.mscodedev.spinestack.infrastructure.importer.removeDashes
import io.github.mscodedev.spinestack.infrastructure.importer.toIsbn10
import io.github.mscodedev.spinestack.infrastructure.search.LuceneEntity
...
import io.github.mscodedev.spinestack.interfaces.api.rest.dto.ReferenceExpansionBook
import io.github.mscodedev.spinestack.interfaces.api.rest.dto.RelationDto
import io.github.mscodedev.spinestack.interfaces.api.rest.dto.toAttributesDto
import io.github.mscodedev.spinestack.jooq.tables.records.BookRecord
...
import io.github.mscodedev.spinestack.jooq.Tables.BOOK as TableBook
import io.github.mscodedev.spinestack.jooq.Tables.BOOK_CONTRIBUTOR as TableBookContributor
import io.github.mscodedev.spinestack.jooq.Tables.BOOK_PUBLISHER as TableBookPublisher
import io.github.mscodedev.spinestack.jooq.Tables.BOOK_TAG as TableBookTag
import io.github.mscodedev.spinestack.jooq.Tables.COLLECTION as TableCollection
import io.github.mscodedev.spinestack.jooq.Tables.IMAGE as TableImage

@Component
class BookDtoDao(
  private val dsl: DSLContext,
  private val userDao: SpineStackUserDao,
  ...
  @Value("#{@spinestackProperties.database.batchChunkSize}") private val batchSize: Int,
) : BookDtoRepository {
  ...
  override fun insert(book: BookCreationDto, user: SpineStackUser): String {
  ...
  override fun update(bookId: String, book: BookUpdateDto, user: SpineStackUser) {
