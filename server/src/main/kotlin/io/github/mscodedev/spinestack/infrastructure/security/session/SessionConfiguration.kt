package io.github.mscodedev.spinestack.infrastructure.security.session
...
class SessionConfiguration {
  ...
  @Bean
  fun customizeSessionRepository(spinestackProperties: SpineStackProperties) =
    SessionRepositoryCustomizer<CaffeineIndexedSessionRepository> {
      it.setDefaultMaxInactiveInterval(spinestackProperties.sessionTimeout.seconds.toInt())
    }
