package io.github.mscodedev.spinestack.infrastructure.swagger
...
class SwaggerConfiguration {
  ...
  fun openApi(): OpenAPI =
    OpenAPI()
      .info(
        Info()
          .title("SpineStack API")
          .version("v1.0")
          .description(
            """
              SpineStack offers a REST API.
          ...
          .license(
            License()
              .name("MIT")
              .url("https://github.com/mscodedev/spinestack/blob/master/LICENSE"),
          ),
      )
      .externalDocs(
        ExternalDocumentation()
          .description("SpineStack documentation")
          .url("https://mscodedev.github.io/spinestack"),
      )
      .components(
        Components()
          .addSecuritySchemes(
      ...
      .addTagsItem(
        Tag()
          ...
          .description(
            """
              The SpineStack API is secured using HTTP Basic Authentication. This means in order
