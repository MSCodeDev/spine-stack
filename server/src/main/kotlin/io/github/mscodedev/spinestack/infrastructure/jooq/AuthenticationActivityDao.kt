...
import io.github.mscodedev.spinestack.jooq.tables.records.AuthenticationActivityRecord
...
import io.github.mscodedev.spinestack.jooq.Tables.AUTHENTICATION_ACTIVITY as TableAuthenticationActivity
...
class AuthenticationActivityDao(
  ...
  override fun findAllByUser(user: SpineStackUser, pageable: Pageable): Page<AuthenticationActivity> {
  ...
  override fun findMostRecentByUser(user: SpineStackUser): AuthenticationActivity? =
  ...
  override fun deleteByUser(user: SpineStackUser) {
