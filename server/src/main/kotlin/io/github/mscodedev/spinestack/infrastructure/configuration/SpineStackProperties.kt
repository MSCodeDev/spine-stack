package io.github.mscodedev.spinestack.infrastructure.configuration
...
@Component("spinestackProperties")
@ConfigurationProperties(prefix = "spinestack")
@Validated
class SpineStackProperties {
