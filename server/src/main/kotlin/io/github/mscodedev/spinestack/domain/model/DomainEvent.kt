...
sealed class DomainEvent : Serializable {
  data class UserAdded(val user: SpineStackUser) : DomainEvent()
  data class UserUpdated(val user: SpineStackUser) : DomainEvent()
  data class UserDeleted(val user: SpineStackUser) : DomainEvent()
  ...
  data class StorePictureAdded(val imageDetails: Image) : DomainEvent()
  data class StorePictureUpdated(val imageDetails: Image) : DomainEvent()
  data class StorePictureDeleted(val imageDetails: Image) : DomainEvent()
}
