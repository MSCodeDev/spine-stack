...
const val METER_TASKS_EXECUTION = "spinestack.tasks.execution"
const val METER_TASKS_FAILURE = "spinestack.tasks.failure"
...
class MetricsPublisherController(
  ...
  val noTagGauges = entitiesNoTags.associateWith { entity ->
    AtomicLong(0).also { value ->
      Gauge.builder("spinestack.$entity", value) { value.get().toDouble() }
